...
public class GameState : AState
{
    ...
    public virtual void Pause(bool displayMenu = true)
	{
    ...
    public virtual void QuitToLoadout()
	{
    ...
    public virtual IEnumerator WaitForGameOver()
	{
		m_Finished = true;
		trackManager.StopMove();
    ...
    public virtual void OpenGameOverPopup()
    {
