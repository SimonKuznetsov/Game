...
{
    [SerializeField] private BarrierSphere _parent;
    ...
    private void Start()
    {
        ...
        _speed = CharacterDataInstance.Instance.FourthCharacterData.BarrierSpeed;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.TryGetComponent(out Character character))
        {
            ...
            {
                var coroutine = StartCoroutine(character.WaitApplyDamage(CharacterDataInstance.Instance.FourthCharacterData.DamageBarrier, false, true));
